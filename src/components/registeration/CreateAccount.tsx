...
import GoogleImage from "/super-g.png";
    ...
    <div className="register bg-offWhite p-6 w-[90%] lg:w-[40%] md:h-[60%] lg:h-[90%] sm:p-12 rounded-3xl">
      <div className="first-row flex justify-between">
        {/* <div className="pages flex space-x-5">
          <NavLink to="/">
            <a href="" className="border-b-2 border-b-activeBorderColor pb-4">
              Register
            </a>
          </NavLink>
      ...
      <div className="brand-icons py-10">
        <div className="icons flex space-x-10 text-2xl">
          ...
          <div className="facebook-icon rounded-full w-12 h-12 text-center flex items-center justify-center  bg-iconsBgCol">
            <FontAwesomeIcon icon={faFacebookF} className="text-faceboolCol" />
          </div>
